...
class CollectionSessionOutputSerializer(serializers.Serializer):
    id = serializers.CharField()
    title = serializers.CharField()
    timestamp = serializers.CharField()
    durationLabel = serializers.CharField()
    score = serializers.IntegerField(min_value=0, max_value=100)
    label = serializers.CharField()
...
class CollectionDetailOutputSerializer(serializers.Serializer):
    session = CollectionSessionOutputSerializer()
    heartRatePoints = serializers.ListField(child=serializers.IntegerField())
    stressPoints = serializers.ListField(child=serializers.IntegerField())
    sensors = serializers.ListField(child=serializers.CharField())
    observation = serializers.CharField()
    recommendation = serializers.CharField()


class InsightSummaryOutputSerializer(serializers.Serializer):
    weeklyStress = serializers.ListField(child=serializers.IntegerField())
    monthlyStress = serializers.ListField(child=serializers.IntegerField())
    burnoutRiskTrend = serializers.ListField(child=serializers.IntegerField())
    criticalFactors = serializers.ListField(child=serializers.CharField())
    trendLabel = serializers.CharField()
...
class ArticleSummaryOutputSerializer(serializers.Serializer):
    id = serializers.CharField()
    title = serializers.CharField()
    category = serializers.CharField()
    readTimeMinutes = serializers.IntegerField(min_value=1)


class ArticleSectionOutputSerializer(serializers.Serializer):
...
class ArticleDetailOutputSerializer(serializers.Serializer):
    ...
    sections = ArticleSectionOutputSerializer(many=True)
    watchSummary = serializers.CharField()
...
class UserProfileOutputSerializer(serializers.Serializer):
    ...
    jobTitle = serializers.CharField(allow_blank=True)
    company = serializers.CharField(allow_blank=True)
    workSchedule = serializers.CharField(allow_blank=True)


class WatchSyncStatusOutputSerializer(serializers.Serializer):
    deviceName = serializers.CharField()
    isConnected = serializers.BooleanField()
    batteryPercent = serializers.IntegerField(min_value=0, max_value=100)
    lastSyncLabel = serializers.CharField()
    syncing = serializers.BooleanField()
